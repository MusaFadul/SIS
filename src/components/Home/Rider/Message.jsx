    ...
    render() {
        ...
        return (
            <div style={{ maxWidth: 720, height: "100%", alignItems: 'center' }}>
                ...
                <h3 style={{ color: '#4dd0e1', fontWeight: 'bold' }}>School Information  System </h3>
                <p className="alt-lead mb-4" style={{ fontSize: 18, color: 'white' }}>
                    SIS is a place where teachers can easily interact with their students without having a website!
